	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						<h2 class="title"><a href="#">Add/Delete Stock </a></h2>

						<div class="entry">
							<p><img src="images/img07.jpg" width="200" height="200" alt="" class="alignleft border" />
                                                        <p><a href="addstock.jsp">ADD STOCK</a></p>
                                                        <p><a href="delstock.jsp">VIEW STOCK</a></p>
                                                        <p><a href="adddiscount.jsp">Add Discount Details</a>
                                                        </p><p><a href="viewdiscount.jsp">View Discount Details</a>
						</div>
					</div>
