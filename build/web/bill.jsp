	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						<h2 class="title"><a href="#">Generate/View Bill </a></h2>

						<div class="entry">
							<p><img src="images/img07.jpg" width="200" height="200" alt="" class="alignleft border" />
                                                        <p><a href="viewbill.jsp">VIEW BILL</a></p>

                                                        <form name="form" action="behaviormarketing.jsp" method="POST">
                                                            <p>Enter the customer Id : <input type="text" name="custid" ></p>
                                                            <p><input type="Submit" name="submit" value="Behavior Prediction"></p>
