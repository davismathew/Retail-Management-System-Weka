		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
                    ...
                    <form action="addcat_serv" method="POST">
                      <table>
                          <tr><td>Category Name:</td><td> <input type="text" name="catname" size="20"></td></tr>
                          <tr><td>Category Id: </td><td><input type="text" name="catid" size="20"></td></tr>
